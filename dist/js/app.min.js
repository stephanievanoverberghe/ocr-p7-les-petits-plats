import{fetchRecipes}from"./api.min.js";import{Recipe}from"./recipe.min.js";let recipes=[],selectedItems={ingredients:new Set,appliances:new Set,ustensils:new Set},dropdownsData=[{id:"ingredients",label:"Ingrédients"},{id:"appliances",label:"Appareils"},{id:"ustensils",label:"Ustensiles"}],generateDropdown=({id:e,label:t})=>`
    ...
    `,t},filterRecipes=e=>{var t=searchRecipesNative(e,recipes),s=[];for(let e=0;e<t.length;e++){var r=t[e];matchesSelectedItems(r,selectedItems)&&s.push(r)}updateRecipeCount(s.length),displayRecipes(s)},updateRecipeCount=e=>{var t=document.querySelector("#recipe-count");let s;s=0===e?"00 recette":1===e?"01 recette":e.toString().padStart(2,"0")+" recettes",t.textContent=s},truncateDescription=(e,t=4)=>{var s=e.split("\n");return s.length<=t?e:s.slice(0,t).join(" ")+"..."},populateSelects=()=>{var t=new Set,s=new Set,r=new Set;for(let e=0;e<recipes.length;e++){var l=recipes[e];addItemsToSet(l.ingredients,t,"ingredient"),s.add(l.appliance),addItemsToSet(l.ustensils,r)}populateSelect("#ingredients-select",t),populateSelect("#appliances-select",s),populateSelect("#ustensils-select",r)},addItemsToSet=(t,s,r)=>{for(let e=0;e<t.length;e++)s.add(r?t[e][r]:t[e])},populateSelect=(e,t)=>{var s=document.querySelector(e),r=(s.innerHTML="",Array.from(t));for(let e=0;e<r.length;e++){var l=r[e],i=document.createElement("option");i.value=l,i.textContent=l,i.classList.add("py-2","capitalize-first-letter"),s.appendChild(i)}},addSelectEventListeners=()=>{["ingredients","appliances","ustensils"].forEach(t=>{document.querySelector(`#${t}-select`).addEventListener("change",e=>{addSelectedItem(t,e.target.value),e.target.value="",filterRecipes(document.querySelector("#search").value)})})},addSelectedItem=(e,t)=>{t&&!selectedItems[e].has(t.toLowerCase())&&(selectedItems[e].add(t.toLowerCase()),updateSelectedItemsDisplay())},updateSelectedItemsDisplay=()=>{var t=document.querySelector("#selected-items"),s=(t.innerHTML="",Object.keys(selectedItems));for(let e=0;e<s.length;e++){var r=s[e],l=Array.from(selectedItems[r]);for(let e=0;e<l.length;e++){var i=l[e],i=createListItem(r,i);t.appendChild(i)}}},createListItem=(e,t)=>{var s=document.createElement("li");return s.classList.add("flex","w-48","items-center","justify-between","rounded-lg","bg-color-site-50","p-4","text-sm"),s.innerHTML=`
        ${escapeHtml(t)}
