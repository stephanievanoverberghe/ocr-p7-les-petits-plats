...
/**
 * Perform a search on recipes using functional programming methods.
...
const searchRecipesFunctional = (query, recipes) => {
    ...
    return recipes.filter(recipe => matchesQueryFunctional(lowerCaseQuery, recipe));
};

/**
 * Check if a recipe matches the search query using functional programming methods.
 * @param {string} query - The search query.
 * @param {Object} recipe - The recipe object.
 * @returns {boolean} - True if the recipe matches the query, false otherwise.
 */
const matchesQueryFunctional = (query, recipe) => {
...
/**
 * Check if a recipe matches the selected items using functional programming methods.
 * @param {Object} recipe - The recipe object.
 ...
 */
const matchesSelectedItemsFunctional = (recipe, selectedItems) => {
    const ingredientMatch = [...selectedItems.ingredients].every(item =>
    ...
    const ustensilMatch = [...selectedItems.ustensils].every(item =>
...
class App {
    ...
    /**
     * Filter the recipes based on the search query and selected items using functional methods.
     * @param {string} query - The search query.
     */
    filterRecipes(query) {
        const filteredRecipes = searchRecipesFunctional(query, this.recipes)
            .filter(recipe => matchesSelectedItemsFunctional(recipe, this.selectedItems));
